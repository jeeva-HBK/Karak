...
public class FragmentAdDrSubChildCardmom extends Fragment implements TextWatcherWithInstance {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mContext = getContext();
        mBinding.txtTeaGms.setText(DR_CARDAMOM_KARAK_TEA);
        mBinding.txtTeaCardmom.setText(DR_CARADMOM_KARAK_CARDMOM);
        mBinding.txtGmsMilk.setText(DR_CARDAMOM_KARAK_MILK);
        mBinding.txtGmsWater.setText(DR_CARDAMOM_KARAK_WATER);
        new MultiTextWatcher().registerEditText(mBinding.txtTeaGms).registerEditText(mBinding.txtTeaCardmom)
                .registerEditText(mBinding.txtGmsMilk).registerEditText(mBinding.txtGmsWater).setCallback(this);
